...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const meta = dict.servicePages.legacyModernization.meta;
...
export default async function Page({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return <ServicePageContent data={dict.servicePages.legacyModernization} shared={dict.servicePages} lang={locale} />;
}
