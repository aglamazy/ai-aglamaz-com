...
export async function generateMetadata({
  ...
  const uc = dict.useCases.documentAutomation;
  const url = `${base}/${locale}/use-cases/document-automation`;
  ...
  return {
    ...
    alternates: {
      canonical: url,
      languages: { he: `${base}/he/use-cases/document-automation`, en: `${base}/en/use-cases/document-automation` },
    },
    openGraph: {
      title: uc.meta.title,
      description: uc.meta.description,
